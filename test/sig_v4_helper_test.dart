...
void main() {
  ...
  test('new SigV4Request generates signed headers and url', () {
    ...
    final awsSigV4Client = AwsSigV4Client('AXXXXXXXXXXXXXXXXXXX',
    ...
    final signedRequest = SigV4Request(awsSigV4Client,
        ...
        headers:
            Map<String, String>.from({'header-1': 'one', 'header-2': 'two'}),
        queryParams: Map<String, String>.from({'color': 'orange red'}),
